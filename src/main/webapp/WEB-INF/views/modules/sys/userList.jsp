...
<div class="head">
	...
	<div class="title">
		<h3>${title}</h3>
		<shiro:hasPermission name="sys:user:edit"><span class="pull-right"><a class="btn btn-primary" href="${ctx}/sys/user/form">用户添加</a></span></shiro:hasPermission>
	</div>

	<form:form id="searchForm" modelAttribute="user" action="${ctx}/sys/user/list" method="post" class="form-inline search ">
