...
<body>
	...
	<div class="content">
		...
		<form:form id="inputForm" modelAttribute="researchproject"
					action="${ctx}/lh/researchproject/inspection" method="post"
			...
			<table>
				<tbody>
					...
					<tr>
						...
						<td class="form-smallestcell">
							<div class="control">
								<form:input path="host" htmlEscape="false" maxlength="64" class="form-control" disabled="true" style="border:0" color="white"/>
							</div>
						</td>
					...
					<tr>
						...
						<td class="form-smallestcell" colspan="3">
							<sys:fileupload id="files" input="files" type="files" savePath="announce" uploadPath="${ctx}/file" selectMultiple="true" value="${researchproject.files}"/>
						</td>	
					</tr>
					<tr>
						...
						<td class="form-smallestcell">
						<input name="finishunit" value="${fns:getDictLabel(researchproject.status,'researchStatus','') }" htmlEscape="false" maxlength="64" class="form-control" disabled="disabled" style="border:0" color="white"/>
							<div class="control">
