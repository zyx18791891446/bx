...
<script src="${ctxStatic}/bootstrap/3.3.7/js/transition.js" type="text/javascript"></script>
...
<link href="${ctxStatic}/bootstrap/3.3.7/css/theme/${not empty cookie.theme.value ? cookie.theme.value : 'default'}.css" type="text/css" rel="stylesheet" />
