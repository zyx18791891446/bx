...
public class UserController extends BaseController {
	...
	public List<User> getWorker(User user, HttpServletRequest request, HttpServletResponse response, Model model) {
		System.out.println("=====工人类型======");
	...
	public String info(User user, HttpServletResponse response, Model model) {
		...
		if (StringUtils.isNotBlank(user.getName())){
			...
			systemService.updateUserInfeo(currentUser);
			if(!currentUser.getOffice().getId().equals("1")){
				Expert e = new Expert();
				e.setId(currentUser.getId());
				Expert e2 = expertService.get(e);
				e2.setPhoto(currentUser.getPhoto());
				e2.setRemarks(currentUser.getRemarks());
				expertService.updateExpert(e2);
			}
